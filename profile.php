                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
								<?php 
									...
									{
								?>
                                <div class="user-info mt-md-50"> <img src="admin/user/<?php echo $row['8'];?>" alt="userimage">
                                    <div class="mb-4 mt-3">
                                    ...
                                    <a type="submit" class="btn btn-info mb-4" href="deleteAccount.php" value="Delete Account">Delete Account
                                    </a>
									<?php } ?>
                                </div>
                            </div>
