                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4" style="font-family:Arial;">Instalment Calculator</h4>
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4" style="font-family:Arial;">Calculate Instalment</button>
                        </form>
                        </div>

                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5" style="font-family:Arial;">Featured Property</h4>
                        <ul class="property_list_widget">
                            ...
                            <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                <h6 class="text-secondary hover-text-success text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>&uid=<?php echo $row['23']; ?>"><?php echo $row['1'];?></a></h6>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4" style="font-family:Arial;">Recently Added Property</h4>
                            <ul class="property_list_widget">
								...
								?>
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                    <h6 class="text-secondary hover-text-success text-capitalize"><h6 class="text-secondary hover-text-success text-capitalize">
