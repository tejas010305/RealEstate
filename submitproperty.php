...
if(isset($_POST['add']))
{
	...
	// Extracting only the Google Maps link from the iframe (if the $locMap already contains the iframe)
    preg_match('/src="([^"]+)"/', $locMap, $matches);
    $mapLink = isset($matches[1]) ? $matches[1] : '';  // This gets the URL from the iframe

   // Now, use the $mapLink variable (which contains the Google Maps URL) to insert into the database
    $sql = "INSERT INTO property (title, pcontent, type, bhk, stype, bedroom, bathroom, balcony, kitchen, hall, floor, size, price, location, city, state, feature, pimage, pimage1, pimage2, pimage3, pimage4, uid, status, mapimage, topmapimage, groundmapimage, totalfloor, isFeatured, locMap) 
    VALUES ('$title', '$content', '$ptype', '$bhk', '$stype', '$bed', '$bath', '$balc', '$kitc', '$hall', '$floor', '$asize', '$price', '$loc', '$city', '$state', '$feature', '$aimage', '$aimage1', '$aimage2', '$aimage3', '$aimage4', '$uid', '$status', '$fimage', '$fimage1', '$fimage2', '$totalfloor', '$isFeatured', '$mapLink')";
                        ...
                        <form method="post" enctype="multipart/form-data">
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="col-xl-12">
												<div class="form-group row">
												      <br><label class="col-lg-2 col-form-label">Location</label>
												     <div class="col-lg-9">
												           <p class="alert alert-success"><b>1. Open Google Maps.<br><b>
																			   2. Search for the place you want (e.g., San Diego Zoo).<b><br><b>
																			   3. Click on the Share button.<b><br><b>
																			   4. Select the Embed a map tab.<b><br><b>
																			   5. Copy URL.<b><br><b>
																			   6. Paste URL</p>
